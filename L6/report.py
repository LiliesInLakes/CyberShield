...
<footer>
Generated by APK Sentinel. Every number on this page derives from a deterministic
analysis layer: scoring weights are computed from measured rule-firing rates,
indicators are extracted from the sample's own bytes, and technique mappings come
from the findings themselves. No part of this report's evidence was produced by a
language model.
